...
import { joinWaitlistSchema } from '@/schemas/miscellaneous'
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(execute)} className='space-y-8'>
        <FormField
          ...
          name='email'
          render={({ field }) => (
            <FormItem className='h-20 space-y-4'>
              <div className='w-fit rounded-xl border bg-background p-1 pl-3 shadow-lg transition-all focus-within:border-primary/50 focus-within:ring focus-within:ring-primary/15 hover:border-primary/50'>
                <FormControl>
                  <input
                    disabled={loading}
